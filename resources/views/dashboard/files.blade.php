...
@php
    ...
    $files = \App\Models\File::where('user_id', $user->id)->get();
@endphp
                    ...
                    <tr class="text-gray-600">
                        <td class="py-2 px-4 border">
                            @if(str_starts_with($file->mime, "image/"))
                                <img src='{{"/f/$file->short_code"}}' class='w-20 h-20 object-scale-down'>
                            @else
                                <div class="w-20 h-20 flex justify-center items-center"></div>
                            @endif
                        </td>
