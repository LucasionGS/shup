...
@php
    ...
    $pasteQuery = \App\Models\PasteBin::where('user_id', $user->id)->orderBy('created_at', 'desc');
    $count = $pasteQuery->count();
    $pageSize = 15;
    $page = max(0, (int) request()->query("page", 0));
    $pastes = $pasteQuery->limit($pageSize)->offset($page * $pageSize)->get();
@endphp
