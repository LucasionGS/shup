...
<body>
    <main class="public-shell">
        <form class="public-card form-stack" method="GET" autocomplete="off">
            @include('partials.app-mark')
            <h1 class="text-2xl font-semibold text-center">Password Required</h1>
            <p class="panel-subtitle text-center">{{ $directory->name }}</p>
            ...
            <button class="btn-primary w-full" type="submit">Open Directory</button>
        </form>
    </main>
</body>
</html>